...
const I18N = {
  en: {
    ...
    'track.title': 'My Account',
    'track.sub': 'Verify your number with an OTP to see your full booking history, then quickly rebook with the same details.',
    'track.phoneLabel': 'Registered Mobile Number',
    'track.phonePlaceholder': '10 digit number',
    'track.checkBtn': 'Verify & View My Bookings',
  ...
  hi: {
    ...
    'track.title': 'मेरा अकाउंट',
    'track.sub': 'अपनी पूरी बुकिंग हिस्ट्री देखने के लिए OTP से नंबर वेरीफाई करें, फिर उन्हीं डिटेल्स से जल्दी दोबारा बुक करें।',
    'track.phoneLabel': 'रजिस्टर्ड मोबाइल नंबर',
    'track.phonePlaceholder': '10 अंकों का नंबर',
    'track.checkBtn': 'वेरीफाई करें और बुकिंग देखें',
